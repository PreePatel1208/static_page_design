...
import { Checkbox, FormControl, FormControlLabel, FormGroup, Paper, Radio, RadioGroup } from '@mui/material';
...
import SliderComponent from './OfferCarasoul';
...
const Main = () => {
    ...
    const styles = {
        container: {
            display: 'flex',
            flexDirection: 'column-reverse', // Reverse the order for small screens
        ...
        return (
            <>
                <Grid container spacing={2}>
                    ...
                    >
                        <ButtonCompo label="ENROLL NOW" size={20} />
                    </Grid>
                </Grid>
            </>
        )
    ...
    return (
        <>
            <ThemeProvider theme={theme}>
                {/* <Grid container spacing={2} sx={{ mt: 3, p: 1 }}>
                    <Grid item xs={12} md={8} sm={12}>
                        <Typography variant="h1">
                            The Complete <Typography variant="h1" color="#352A9A">
                    ...
                    <Grid item xs={12} md={4} sm={6}
                        sx={{ display: { xs: "flex" }, justifyContent: { sm: "center" }, alignItems: "center" }}
                    >
                        <img
                            src={Video1}
                            alt="video"
                ...
                <ButtonCompo label="Buy Now" size={20} /> */}
                <Grid container spacing={2} sx={{ mt: 3, p: 1 }}>
                    <Grid item xs={12} md={8} sm={12}>
                        <Typography variant="h1">
                            The Complete <Typography variant="h1" color="#352A9A">
                    ...
                    >
                        <Box
                            sx={{
                                width: { xs: '80%', sm: '80%', md: "100%" }, // Set width to 70% for 'xs' and 'sm'
                                margin: '5%', // Add 5% margin
                                textAlign: 'center',
                            }}
                        >
                            <img
                ...
                <Box
                    sx={{
                        width: '100%',
                        margin: { xs: '5%', sm: '5%', md: '0' }, // Add 5% margin for 'xs' and 'sm', 0 margin for 'md' and up
                        display: 'flex',
                        justifyContent: { xs: 'center', sm: 'center', md: 'flex-start' }, // Center horizontally for 'xs' and 'sm', left for 'md' and up
                ...
                <Grid container spacing={2} sx={{ mt: 4 }}>
                    ...
                    <Grid item xs={12} sm={4} md={2} sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
                        <img
                            src={user}
                            alt="user"
                            loading="lazy"
                ...
                >
                    <Grid item xs={12} sm={8} sx={containerstyles.container}>
                    ...
                    <Grid item xs={12} sm={8} >
                        ...
                        <Grid
                            ...
                            sx={{
                                borderRadius: 1,
                                display: 'flex',
                                maxWidth: { xs: 50, sm: 350, md: 350 }, // Limit width on larger screens
